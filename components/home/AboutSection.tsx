...
const features = [
  "Tim desain pemenang penghargaan",
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="mb-6 text-lg text-muted-foreground FONT">
              Di Knock, kami percaya bahwa setiap ruang memiliki potensi untuk menjadi luar biasa. 
              Dengan pengalaman lebih dari 15 tahun, tim desainer dan arsitek berbakat kami 
              telah mengubah banyak rumah menjadi rumah impian.
            </p>
